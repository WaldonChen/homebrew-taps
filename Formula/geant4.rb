class Geant4 < Formula
  ...
  bottle do
    sha256 cellar: :any, big_sur: "ce38842159bae58ab7c34c6cb66491a7dcd39fd6548e984ce4f3f5d7af857ffe"
  end

  # resource "G4NDL" do
  #   url "https://geant4-data.web.cern.ch/datasets/G4NDL.4.6.tar.gz"
  #   sha256 "9d287cf2ae0fb887a2adce801ee74fb9be21b0d166dab49bcbee9408a5145408"
  # end

  # resource "G4EMLOW" do
  #   url "https://geant4-data.web.cern.ch/datasets/G4EMLOW.7.13.tar.gz"
  ...
  #   url "https://geant4-data.web.cern.ch/datasets/G4PARTICLEXS.3.1.1.tar.gz"
  ...
  # resource "G4TENDL" do
  #   url "https://geant4-data.web.cern.ch/datasets/G4TENDL.1.3.2.tar.gz"
